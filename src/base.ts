import { Sprite, Assets, Application, Container, Texture } from "pixi.js"
...
export class Base {
  ...
  insertIntoContainer(container: Container) {
    if ((typeof this.sprite) == undefined) return false
  ...
  async load(app: Application) {
    ...
    this.sprite.position.set(baseOriginX, app.screen.height - this.sprite.height / 2)
